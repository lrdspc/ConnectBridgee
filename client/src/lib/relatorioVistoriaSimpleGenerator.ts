      ...
      sections: [
        {
          ...
          children: [
            ...
            new Paragraph({
              text: relatorio.observacoesGerais || "Sem observações adicionais.",
              alignment: AlignmentType.JUSTIFIED,
              spacing: { after: 360 } // Espaçamento para assinatura
            }),
            ...
            new Paragraph({
              ...
              alignment: AlignmentType.CENTER,
              spacing: { before: 720 } // Espaço para assinatura física
            }),
            new Paragraph({
              text: "Assistência Técnica - Brasilit",
              alignment: AlignmentType.CENTER,
            })
          ]
        }
