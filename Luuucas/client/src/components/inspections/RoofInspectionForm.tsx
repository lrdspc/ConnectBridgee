...
import { X, Plus, Calendar, Camera, Save, Zap } from "lucide-react";
...
export function RoofInspectionForm({ visitId, onComplete }: RoofInspectionFormProps) {
  ...
  const fillRandomData = () => {
    // Gera uma inspeção aleatória
    const randomInspection = generateRandomInspection();
    
    // Atualiza o formulário com os dados aleatórios
    form.reset({
      clientName: randomInspection.clientName,
      dateInspected: randomInspection.dateInspected,
      constructionType: randomInspection.constructionType as any,
      customConstructionType: randomInspection.customConstructionType,
      address: randomInspection.address,
      city: randomInspection.city,
      inspectionSubject: randomInspection.inspectionSubject,
      protocolNumber: randomInspection.protocolNumber,
      technicianId: randomInspection.technicianId,
      technicianName: randomInspection.technicianName,
      department: randomInspection.department,
      unit: randomInspection.unit,
      region: randomInspection.region,
      coordinatorName: randomInspection.coordinatorName,
      managerName: randomInspection.managerName,
      conclusion: randomInspection.conclusion,
      recommendations: randomInspection.recommendations,
    });
    
    // Atualiza as especificações de telhas
    setTileSpecs(randomInspection.tileSpecs as TileSpec[]);
    
    // Atualiza os problemas selecionados
    setSelectedIssues(randomInspection.issues as string[]);
